      ...
      <ion-content class='ion-padding'>
        <form onSubmit={this.handleSubmit} autocomplete="off">
          ...
          <ion-list lines='full'>
            ...
            <ion-item>
              <ion-datetime name='datetwo' size="cover" presentation="date-time" prefer-wheel="true" show-default-buttons="false" done-text="All set" cancel-text="Never mind" onIonChange={this.handleDateTimeChangeTwo.bind(this)} ></ion-datetime>
            </ion-item>
          </ion-list>
